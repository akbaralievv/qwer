...
import CreateOrderForAdmissons from '../CreateOrderForAdmissons';
import UpdateOrderForAdmissions from '../UpdateOrderForAdmissons';
import OrderForAdmissionsViewModal from '../OrderForAdmissionsViewModal';
import OrderForAdmissionsActionsPopover from '../OrderForAdmissionsActionsPopover';

const COLUMN_KEY = 'order_for_admissions_column_settings';
...
export default function OrderForAdmissionsPage() {
  // --- Колонки (настройки) ---
  ...
  const FILTER_KEY = 'reception_period';
  ...
  // --- Поиск: теперь не фильтруем строки ---
  ...
  return (
    <Box sx={{ mt: 0, background: '#f6f7f9', minHeight: '100vh', pb: 0 }}>
      ...
      {menuRow && originalRow && (
        <OrderForAdmissionsActionsPopover
