...
import { useCreateSubdivOnesMutation } from 'src/store/api/subdivOnes';

function CreateSubdivOne({
  setOpen,
  setSnackbarOpen,
  snackbarOpen,
  setSnackbarMessage,
  ...
  const [createData] = useCreateSubdivOnesMutation();
...
export default CreateSubdivOne;
